...
public class EmojiCollectWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(EmojiCollectWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/EmotiCollectWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/EmotiCollectWLAIW/InitOutcome.xml").getDocumentElement();
